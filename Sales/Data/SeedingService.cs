...
namespace Sales.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "Maria@gmail.com", new DateTime(1987, 3, 31), 200.0, d1);
            Seller s3 = new Seller(3, "Alex Grey", "Alex@gmail.com", new DateTime(1985, 10, 25), 3500.0, d1);
            Seller s4 = new Seller(4, "Martha ", "Martha@gmail.com", new DateTime(1994, 5, 01), 2500.0, d1);
            Seller s5 = new Seller(5, "Donald Blue", "Donald@gmail.com", new DateTime(1998, 11, 24), 800.0, d1);
            Seller s6 = new Seller(6, "Alex Pink", "Bob@gmail.com", new DateTime(1993, 2, 15), 5000.0, d1);
